		...
		<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<p class="question"><input name="fields['improve-website-content']" id="improve-website-content" type="checkbox" value="false"> Improve Website Content</p>
							<ul>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<p class="question"><input name="fields['improve-website-maintenance']" id="improve-website-maintenance" type="checkbox" value="false"> Improve Website Maintenance</p>
							<ul>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<p class="question"><input name="fields['monitor-effectiveness']" id="monitor-effectiveness" type="checkbox" value="false"> Monitor Effectiveness</p>
							<ul>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<p class="question"><input name="fields['improve-brand-awareness']" id="improve-brand-awareness" type="checkbox" value="false"> Improve Brand Awareness</p>
							<ul>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<p class="question"><input name="fields['enhance-visibility']" id="enhance-visibility" type="checkbox" value="false"> Enhance Visibility</p>
							<ul>
