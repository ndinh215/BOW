	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				<p>Advertiser:<input name="advertiser-text" type="text"/></p>
				<p>Address:<input name="address-text" type="text"/></p>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				<div class="row">
					<p><input name="option-A" type="checkbox"/>Option A</p>
				</div>
				<div class="row">
					<table style="width:100%">
						<tr>
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				<div class="row">
					<p><input name="option-B" type="checkbox"/>Option B</p>
				</div>
				<div class="row">
					<table style="width:100%">
						<tr>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<p>1. The above mentioned proposal would be due on <input name="terms-conditions-text" type="text"/> (PanPages Online Sdn Bhd reserved the right on the rate changes after promotion due date).</p>
